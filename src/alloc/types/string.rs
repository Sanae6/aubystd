use core::{
  fmt::Debug, ops::{Deref, DerefMut}, str::Utf8Error
};

use thiserror::Error;

use crate::{
  alloc::{GrowthStrategy, SliceAllocator, UnsizedMaybeUninit, strategy::Strategy, types::vec::Vec}, io::StreamWrite, types::vec::SliceVec
};
  ...
  S::Handle<'a, SliceVec<u8>>: Deref<Target = SliceVec<u8>>,
{
  ...
  where
    S::UninitHandle<'a, UnsizedMaybeUninit<SliceVec<u8>>>: DerefMut<Target = UnsizedMaybeUninit<SliceVec<u8>>>,

...
impl Strategy for RcStrategy {
    ...
    type SliceData<'allocator, T: ?Sized + 'allocator> = RcData<'allocator, T>;
    type SizedHandle<'allocator, T: 'allocator> = Rc<'allocator, T>;
    type SliceHandle<'allocator, T: ?Sized + 'allocator> = Rc<'allocator, T>;
    ...
    type UninitSliceHandle<'allocator, T: ?Sized + 'allocator> =
        Rc<'allocator, UnsizedMaybeUninit<T>>;
